...
![Liftwithsultan homepage](./assets/Hero_section.png)

- **Where can I see your demo?** [liftwithsulta.netlify.app](https://liftwithsulta.netlify.app)
...
- Each link scrolls to its relevant section on the homepage
- Includes a mobile hamburger menu that toggles open/closed

**Hero Section** — Bold headline and subtitle aimed at complete beginners

- Includes a stats row (experience required, workouts/week, weeks to build the habit) and two calls to action

**How It Works Section** — A 3-step explainer walking through how to use the site

- Pick a plan, follow the sets, track your lifts

**Workout Plans Section** — A filterable grid of beginner workout plans

- Filter tabs for All / Strength / Cardio / Mobility
- Each plan card shows a difficulty rating, session frequency, and duration

**Sign Up / Log In** — Account creation and login forms

- Full client-side validation (required fields, email format, password match)
- Currently front-end only — no backend or stored accounts yet
...
- Instagram: [@liftewithsultan](https://instagram.com/liftewithsultan)
- WhatsApp: 0701 272 2266
- Email: [abdullahiakilu2003@gmail.com](mailto:abdullahiakilu2003@gmail.com)
